...
(8, 36, 1, 11, 12, 1, 'news', 'com_content', 'ニュース', 'news', '', '<p>これは私たちからの最新のニュースです。</p><p>コンテンツカテゴリ管理でこの説明を編集できます。</p><p>これは最新の記事を表示します。 簡単に設定を変更してより多くの表示することができます。</p><p>左側のモジュールに古い記事のリストが表示されます。</p>', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 42, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1);
